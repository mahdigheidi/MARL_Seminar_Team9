...
\centering
\begin{adjustbox}{max width=\linewidth, max height=0.66\textheight}
\begin{tikzpicture}[
    neuron/.style={
        circle,
        draw,
...
\begin{frame}
    ...
    % Left column
        \begin{column}{0.48\textwidth}
            ...
            \vspace{0.4em}
            {\small\textbf{Agents with different roles, and usually different goals}}
        \end{column}
    ...
    % Right column
        ...
        \vspace{0.4em}
        {\small\textbf{The agent have the same actions to do, same goals and observations}}
        \end{column}
    \end{columns}
\end{frame}
...
\node[agentdart]     (a4) at (0,1.2) {};
\node[agenttriangle] (a5) at (3.1,-1.2) {};
